...
class load():
    ...
    def load_data(self,flag='indian'):
        if flag == 'indian':
            Ind_pines_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/Indian_pines.mat')
            Ind_pines_gt_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/Indian_pines_gt.mat')
            ...
            categories = 17
        if flag == 'pavia':
            pav_univ_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/PaviaU.mat')
            pav_univ_gt_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/PaviaU_gt.mat')
        ...
        if flag == 'houston':
            houst_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/Houston.mat')
            houst_gt_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/Houston_GT.mat')
        ...
        if flag == 'salina':
            salinas_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/Salinas_corrected.mat')
            salinas_gt_dict = scio.loadmat('/dat01/dubo_01/DW/Dataset/Salinas_gt.mat')
